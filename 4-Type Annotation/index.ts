/*
Type annotation in typescript  are used to explicitly specify the type of a variable, function parameter, or object property. This helps catch errors
early, improves code readability, and ensure type safety.
